...
class MonthCalendarElement extends ThemableMixin(GestureEventListeners(PolymerElement)) {
  static get template() {
    ...
    <style>
      ...
      [part="span-header"]:hover {
        cursor: pointer;
        text-decoration: underline;
      }

      [part="span-header"][disabled] {
        color: grey;
      }

      [part="span-header"][disabled]:hover {
        cursor: default;
    ...
    <div part="month-header" role="heading">
      <span id="month-header" part="span-header" disabled\$="[[_isMonthClickable(minDate, maxDate, canBeFuzzy)]]" on-tap="_monthTap">[[_getMonth(month, i18n.monthNames)]]</span>
      <span id="year-header" part="span-header" disabled\$="[[_isYearClickable(minDate, maxDate, canBeFuzzy)]]" on-tap="_yearTap">[[_getYear(month, i18n.monthNames)]]</span>
    </div>
